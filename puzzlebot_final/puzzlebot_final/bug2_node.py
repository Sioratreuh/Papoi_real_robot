...
class PureBug2Node(Node):
    def __init__(self):
        ...
        self.min_progress = 0.10   # minProgress
        self.m_line_tol = 0.10     # Tolerancia de interceptacion M-Line
        self.goal_tol = 0.15
        ...
        self.get_logger().info('Pure Bug2: Logica de esquinas y Paro de Emergencia activos.')
    ...
    def scan_callback(self, msg):
        ...
        for i, r in enumerate(msg.ranges):
            ...
            # Angulo REAL del rayo respecto al frente del robot (0 = frente, + = izquierda)
        ...
        # --- DEBUG de calibracion (quitalo cuando ya este afinado) ---
    ...
    def control_loop(self):
        ...
        if self.state == 'GO_TO_GOAL':
            ...
            # Condicion de Salida Estricta
            if d_line < self.m_line_tol and progress_condition and path_clear:
                self.get_logger().info('M-Line Interceptada (Progreso valido). Regresando a GTG.')
                self.state = 'GO_TO_GOAL'
            else:
